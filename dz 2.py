# C:\Users\artkr\HomeworkCourse\dz 2\students.txt
# C:\Users\artkr\HomeworkCourse\dz 2\themes.txt
# C:\Users\artkr\HomeworkCourse\dz 2\tickets.txt
import random
...
if __name__ == "__main__":
    students_file = input("Введите путь к файлу студенты: ")
    questions_file = input("Введите путь к файлу вопросы: ")
    output_file = input("Введите путь к файлу для билетов: ")
